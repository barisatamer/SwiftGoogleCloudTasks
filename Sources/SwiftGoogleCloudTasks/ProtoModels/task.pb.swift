...
public struct Google_Cloud_Tasks_V2beta3_Task {
  ...
  public var payloadType: Google_Cloud_Tasks_V2beta3_Task.OneOf_PayloadType? = nil
  ...
  public var httpRequest: Google_Cloud_Tasks_V2beta3_HttpRequest {
    get {
      if case .httpRequest(let v)? = payloadType {return v}
      return Google_Cloud_Tasks_V2beta3_HttpRequest()
    }
    set {payloadType = .httpRequest(newValue)}
  }
  ...
  public var dispatchDeadline: SwiftProtobuf.Google_Protobuf_Duration {
    get {return _dispatchDeadline ?? SwiftProtobuf.Google_Protobuf_Duration()}
    set {_dispatchDeadline = newValue}
  }
  /// Returns true if `dispatchDeadline` has been explicitly set.
  public var hasDispatchDeadline: Bool {return self._dispatchDeadline != nil}
  /// Clears the value of `dispatchDeadline`. Subsequent reads from it will return its default value.
  public mutating func clearDispatchDeadline() {self._dispatchDeadline = nil}

  /// Output only. The number of attempts dispatched.
  ///
  /// This count includes attempts which have been dispatched but haven't
  /// received a response.
  public var dispatchCount: Int32 = 0

  /// Output only. The number of attempts which have received a response.
  public var responseCount: Int32 = 0
  ...
  public var firstAttempt: Google_Cloud_Tasks_V2beta3_Attempt {
    get {return _firstAttempt ?? Google_Cloud_Tasks_V2beta3_Attempt()}
    set {_firstAttempt = newValue}
  }
  /// Returns true if `firstAttempt` has been explicitly set.
  public var hasFirstAttempt: Bool {return self._firstAttempt != nil}
  /// Clears the value of `firstAttempt`. Subsequent reads from it will return its default value.
  public mutating func clearFirstAttempt() {self._firstAttempt = nil}

  /// Output only. The status of the task's last attempt.
  public var lastAttempt: Google_Cloud_Tasks_V2beta3_Attempt {
    get {return _lastAttempt ?? Google_Cloud_Tasks_V2beta3_Attempt()}
    set {_lastAttempt = newValue}
  }
  /// Returns true if `lastAttempt` has been explicitly set.
  public var hasLastAttempt: Bool {return self._lastAttempt != nil}
  /// Clears the value of `lastAttempt`. Subsequent reads from it will return its default value.
  public mutating func clearLastAttempt() {self._lastAttempt = nil}

  /// Output only. The view specifies which subset of the [Task][google.cloud.tasks.v2beta3.Task] has
  /// been returned.
  public var view: Google_Cloud_Tasks_V2beta3_Task.View = .unspecified
  ...
  public enum OneOf_PayloadType: Equatable {
    ...
    public static func ==(lhs: Google_Cloud_Tasks_V2beta3_Task.OneOf_PayloadType, rhs: Google_Cloud_Tasks_V2beta3_Task.OneOf_PayloadType) -> Bool {
      switch (lhs, rhs) {
      case (.appEngineHTTPRequest(let l), .appEngineHTTPRequest(let r)): return l == r
      case (.httpRequest(let l), .httpRequest(let r)): return l == r
  ...
  fileprivate var _dispatchDeadline: SwiftProtobuf.Google_Protobuf_Duration? = nil
  fileprivate var _firstAttempt: Google_Cloud_Tasks_V2beta3_Attempt? = nil
  fileprivate var _lastAttempt: Google_Cloud_Tasks_V2beta3_Attempt? = nil
}
...
extension Google_Cloud_Tasks_V2beta3_Task: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeSingularMessageField(value: &self._scheduleTime)
      case 5: try decoder.decodeSingularMessageField(value: &self._createTime)
      case 6: try decoder.decodeSingularInt32Field(value: &self.dispatchCount)
      case 7: try decoder.decodeSingularInt32Field(value: &self.responseCount)
      case 8: try decoder.decodeSingularMessageField(value: &self._firstAttempt)
      case 9: try decoder.decodeSingularMessageField(value: &self._lastAttempt)
      case 10: try decoder.decodeSingularEnumField(value: &self.view)
      case 11:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.payloadType = .httpRequest(v)}
      case 12: try decoder.decodeSingularMessageField(value: &self._dispatchDeadline)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if case .appEngineHTTPRequest(let v)? = self.payloadType {
    ...
    if self.dispatchCount != 0 {
      try visitor.visitSingularInt32Field(value: self.dispatchCount, fieldNumber: 6)
    }
    if self.responseCount != 0 {
      try visitor.visitSingularInt32Field(value: self.responseCount, fieldNumber: 7)
    }
    if let v = self._firstAttempt {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
    }
    if let v = self._lastAttempt {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 9)
    }
    if self.view != .unspecified {
      try visitor.visitSingularEnumField(value: self.view, fieldNumber: 10)
    }
    if case .httpRequest(let v)? = self.payloadType {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 11)
    }
    if let v = self._dispatchDeadline {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2beta3_Task, rhs: Google_Cloud_Tasks_V2beta3_Task) -> Bool {
    ...
    if lhs._dispatchDeadline != rhs._dispatchDeadline {return false}
    if lhs.dispatchCount != rhs.dispatchCount {return false}
    if lhs.responseCount != rhs.responseCount {return false}
    if lhs._firstAttempt != rhs._firstAttempt {return false}
    if lhs._lastAttempt != rhs._lastAttempt {return false}
...
extension Google_Cloud_Tasks_V2beta3_Attempt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._scheduleTime)
      case 2: try decoder.decodeSingularMessageField(value: &self._dispatchTime)
      case 3: try decoder.decodeSingularMessageField(value: &self._responseTime)
      case 4: try decoder.decodeSingularMessageField(value: &self._responseStatus)
      default: break
      }
    }
  }
