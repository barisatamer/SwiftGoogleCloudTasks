...
public struct Google_Cloud_Tasks_V2beta3_Task {
  ...
  public var pullMessage: Google_Cloud_Tasks_V2beta3_PullMessage {
    get {
      if case .pullMessage(let v)? = _storage._payloadType {return v}
      return Google_Cloud_Tasks_V2beta3_PullMessage()
    }
    set {_uniqueStorage()._payloadType = .pullMessage(newValue)}
  }
  ...
  public enum OneOf_PayloadType: Equatable {
    ...
    /// queues to provide a way to inspect contents of pull tasks through the
    /// [CloudTasks.GetTask][google.cloud.tasks.v2beta3.CloudTasks.GetTask].
    case pullMessage(Google_Cloud_Tasks_V2beta3_PullMessage)
...
extension Google_Cloud_Tasks_V2beta3_Task: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    13: .standard(proto: "pull_message"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 13: try {
          var v: Google_Cloud_Tasks_V2beta3_PullMessage?
          if let current = _storage._payloadType {
            try decoder.handleConflictingOneOf()
            if case .pullMessage(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._payloadType = .pullMessage(v)}
        }()
        default: break
        }
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if case .pullMessage(let v)? = _storage._payloadType {
