...
public struct Google_Type_DateTime {
  ...
  public enum OneOf_TimeOffset: Equatable {
    ...
    public static func ==(lhs: Google_Type_DateTime.OneOf_TimeOffset, rhs: Google_Type_DateTime.OneOf_TimeOffset) -> Bool {
      switch (lhs, rhs) {
      case (.utcOffset(let l), .utcOffset(let r)): return l == r
...
extension Google_Type_DateTime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeSingularInt32Field(value: &self.hours)
      case 5: try decoder.decodeSingularInt32Field(value: &self.minutes)
      case 6: try decoder.decodeSingularInt32Field(value: &self.seconds)
      case 7: try decoder.decodeSingularInt32Field(value: &self.nanos)
      case 8:
